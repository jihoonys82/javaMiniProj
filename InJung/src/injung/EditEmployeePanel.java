...
public class EditEmployeePanel extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource().equals(btnConfirm)) {
			...
			int selected = JOptionPane.showOptionDialog(buttonPane, "모든 필드의 내용이 지워집니다. 진행하시겠습니까?", "Confirm",
	 ...
	 * Field Validation
	 * 
	 * @return If all field are valid return 0. <br>
	 *         The return figure means the number of invalid items
	 */
