...
//			root.add(comp); // 컨테이너 넣기
	...
	private int logOut() {
		...
		int yesNo = JOptionPane.showOptionDialog(root, "현재 로그인 상태입니다. 로그아웃 하시겠습니까?", "", JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

		if (yesNo == 0) {
			JOptionPane.showMessageDialog(root, "로그아웃 되었습니다.", "", JOptionPane.INFORMATION_MESSAGE);
		}
